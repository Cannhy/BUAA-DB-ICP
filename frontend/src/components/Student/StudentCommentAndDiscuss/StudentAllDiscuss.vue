              ...
              <el-row>
                ...
                <el-col :span="3">
                  <el-button
                    type="primary"
                    icon="el-icon-search"
                    style="display: inline-block; white-space: nowrap; cursor: pointer; background: #fff; border: 1px solid #dcdfe6; color: #2277aa; -webkit-appearance: none; box-sizing: border-box; transition: 0.1s; font-weight: 500; font-size: 17px; border-radius: 4px; float: left; margin-right: 10px;margin-left: 20px"
                  ...
                  <el-button
                    type="primary"
                    icon="el-icon-plus"
                    style="display: inline-block; white-space: nowrap; cursor: pointer; background: #fff; border: 1px solid #dcdfe6; color: #2277aa; -webkit-appearance: none; box-sizing: border-box; transition: 0.1s; font-weight: 500; font-size: 17px; border-radius: 4px;"
...
export default {
  ...
  components: {StudentMenu, quillEditor},
  data: function () {
    return {
      userName: '',
      userNickName: '',
      ...
      showPostThemeList: [
        {
          ...
          userNickName: '舰长',
          title: 'asdsad',
          content: '阿四低洼打撒达瓦达瓦阿萨德瓦达达娃拉开觉得卡拉我觉得卡拉瓦阿斯利康角度来看挖掘的卡拉我就看了',
          time: '2001-8月22日-12:00',
          isTeacher: 1
        }
      ],
