    ...
    <div class="background">
      ...
      <div class="register_block">
        ...
        <el-form rules="rules">
          <div id="register-n">
            <el-form-item>
              <el-input class="inputs" style="width: 290px" type="text" size="medium" placeholder="请输入姓名"
                        v-model="userNickName" clearable></el-input>
            </el-form-item>
          </div>
          <div id="register-name">
            <el-form-item>
              <el-input class="inputs" style="width: 290px" type="text" size="medium" placeholder="请输入账号"
