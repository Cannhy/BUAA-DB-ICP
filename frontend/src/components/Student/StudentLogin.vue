      ...
      <div class="register_block">
        ...
        <el-form>
          <div id="register-name">
            <el-form-item>
              <el-input class="inputs" style="width: 290px" type="text" size="medium" placeholder="请输入学号" v-model="userName" clearable></el-input>
            </el-form-item>
          </div>
          ...
          <div class="register-button">
            <el-button id="button_re" type="success" :plain="true" size="medium" v-on:click="goToStudentRegister">
              注册
            </el-button>
          </div>
          <div class="register-button">
