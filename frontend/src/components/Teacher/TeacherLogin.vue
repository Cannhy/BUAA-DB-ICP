      ...
      <div class="register_block">
        ...
        <el-form>
          <div id="register-name">
            <el-form-item>
              <el-input class="inputs" style="width: 290px" type="text" size="medium" placeholder="请输入工号"
          ...
          <div class="confirm-button">
            <el-button id="button_in_teacher" size="medium" v-on:click="goToTeacherHead">
              确认
            </el-button>
          </div>
          <div class="register-button">
            <el-button id="button_re" :plain="true" size="medium" v-on:click="goToTeacherRegister">
              注册
            </el-button>
          </div>
          <div class="register-button">
