    ...
    <div class="background">
      ...
      <div class="register_block">
        ...
        <el-form>
          <div id="register-n">
            <el-form-item>
              <el-input class="inputs" style="width: 290px" type="text" size="medium" placeholder="请输入姓名" v-model="userNickName" clearable></el-input>
            </el-form-item>
          </div>
          <div id="register-name">
            <el-form-item>
              <el-input class="inputs" style="width: 290px" type="text" size="medium" placeholder="请输入工号" v-model="userName" clearable></el-input>
            </el-form-item>
          </div>
          ...
          <div class="return-button">
            <el-button id="button_re" plain="true" size="medium" v-on:click="goToTeacherLogin">
              返回
            </el-button>
          </div>
        </el-form>
