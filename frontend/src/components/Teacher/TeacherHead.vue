    ...
    <el-container class="background">
      ...
      <el-container class="main">
        ...
        <el-main style="padding-left: 10%; padding-right: 10%">
          <h2>ICP课程平台</h2>
          <h1>简介</h1>
          <p style="line-height: 2;">ICP(Multi-functional Integrated Course Platform)，是集选课系统、课程评价、推荐课程、作业统计、学习资料管理、公共讨论区于一体的面向老师和学生的课程平台，旨在方便北航学生对学习任务的统一管理和教师对课程的安排，提高师生教学效率。</p>
